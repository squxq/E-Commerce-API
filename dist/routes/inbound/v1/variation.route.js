...
router.post("/create/option", validate(variationValidation.createVariationOptions), variationController.createVariationOptions);
router.patch("/update/option", validate(variationValidation.updateVariationOption), variationController.updateVariationOption);
router.delete("/delete/option/:optionId", validate(variationValidation.deleteVariationOptions), variationController.deleteVariationOptions);
module.exports = router;
//# sourceMappingURL=variation.route.js.map